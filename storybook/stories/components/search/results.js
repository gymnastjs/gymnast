...
export default function SearchResults({
  ...
  return (
    <Grid size={size} className={styles.colors2} align="top">
      <Grid>
        <Col size={4}>
        ...
        <Col size={3} align="center" justify="right">
          <Grid className={styles.colors4} size={2}>
      ...
      {new Array(results).fill(0).map(() =>
        <Grid>
          <Col size={5}>
            <Grid margin={[0, 0, 0.5, 0]} className={styles.colors1}>
            ...
            <Grid>
              ...
              elit.
              Vestibulum eu ipsum quis mi rhoncus luctus. Quisque
              eros
              lorem, elementum et...
            </Grid>
          </Col>
          <Col size={4} align="top">
            <Grid margin={[0, 0, 0.5, 0]} className={styles.colors4}>
              status text ipsum
            </Grid>
      ...
      <Col justify="center" size="auto">
        ...
        <Col marginBottom={0} size={4} align="center">
          {times(pages, num =>
            <Col marginBottom={0} size="auto">{num + 1}</Col>
          )}
          <Col marginLeft={0} marginBottom={0} size="auto">...</Col>
          <Col marginLeft={0} marginBottom={0} size="auto">1,485</Col>
        </Col>
        <Col marginBottom={0} size="fit">
          <Grid justify="center" className={styles.paginationArrow}>
            &gt;
