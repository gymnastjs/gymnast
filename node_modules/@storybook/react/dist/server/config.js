...
exports.default = function (configType, baseConfig, configDir) {
  ...
  if (!_fs2.default.existsSync(customConfigPath)) {
    ...
    var _customConfig = require(customConfigPath);

    if (typeof _customConfig === 'function') {
      logger.info('=> Loading custom webpack config (full-control mode).');
      return _customConfig(config, configType);
    } else {
      logger.info('=> Loading custom webpack config (extending mode).');
      return (0, _extends3.default)({}, _customConfig, config, {
        // Override with custom devtool if provided
        devtool: _customConfig.devtool || config.devtool,
        // We need to use our and custom plugins.
        plugins: [].concat((0, _toConsumableArray3.default)(config.plugins), (0, _toConsumableArray3.default)(_customConfig.plugins || [])),
        module: (0, _extends3.default)({}, config.module, _customConfig.module, {
          rules: [].concat((0, _toConsumableArray3.default)(config.module.rules), (0, _toConsumableArray3.default)(_customConfig.module.rules || []))
        }),
        resolve: (0, _extends3.default)({}, config.resolve, _customConfig.resolve, {
          alias: (0, _extends3.default)({}, config.alias, _customConfig.resolve && _customConfig.resolve.alias)
        })
      });
    }
  }
